...
> Movie-App is a website that uses an API to retrieve data, built with HTML, SCSS, and TypeScript. We utilize linters to overcome code errors and maintain clean code. Please check out the live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Movie-App/src/)
